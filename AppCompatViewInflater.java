...
public class AppCompatViewInflater {
    ...
    private static final Map<String, Constructor<? extends View>> sConstructorMap = new androidx.a.a();
    ...
    private View createViewFromTag(Context context, String str, AttributeSet attributeSet) {
        if (str.equals("view")) {
            str = attributeSet.getAttributeValue(null, ClassFields.FIELD_CLASS);
        }
        try {
    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if (Build.VERSION.SDK_INT < 15 || r.B(view)) {
